  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 p-4 space-y-4">
      ...
      <div className="flex items-start justify-between">
        ...
        {isLive && (
          <div className="flex items-center gap-1.5 bg-red-50 text-red-600 text-[11px] font-semibold px-2 py-1 rounded-full">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col items-center text-center w-24">
          <div className="relative h-14 w-14 rounded-full overflow-hidden bg-neutral-100">
            {teamA.image ? (
              <Image
                src={teamA.image}
                alt="Team A"
              ...
              <div className="flex items-center justify-center h-full w-full text-sm font-bold text-neutral-500">
                {teamA.players[0]?.charAt(0)}
              </div>
            )}
          </div>

          <p className="text-xs font-medium text-neutral-800 mt-2 truncate w-full">
            {teamA.players.join(" & ")}
          </p>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="mt-1 text-[11px] font-semibold bg-orange-100 text-orange-600 px-2 py-0.5 rounded-full">
