    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-orange-500 to-orange-600">
            ...
            <div className="flex items-center justify-between p-4">
                <Link href={routes.orgEventMatches(tournamentId, eventId)} className="p-2 text-white">
                    <ArrowLeftIcon size={20} />
                </Link>
                <Link href={routes.orgTournamentDetail(tournamentId)} className="p-2 text-white">
                    <XIcon size={20} />
                </Link>
            </div>
            ...
            <div className="bg-[var(--color-surface)] rounded-t-3xl min-h-[50vh] p-6">
                ...
                <Link
                    href={routes.orgTournamentDetail(tournamentId)}
